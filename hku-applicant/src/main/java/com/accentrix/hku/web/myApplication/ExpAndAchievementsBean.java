...
public class ExpAndAchievementsBean implements Serializable {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory.getLogger(ExpAndAchievementsBean.class);
    ...
    public boolean save() {
        ...
        try {
            ...
            if (expAndAchievementsVo != null) {
                ...
                AuditLogUtil.saveAuditLog(accountVo.getId(), Constants.SAVED_ACHIEVEMENTS);
            }
        } catch (Exception e) {
