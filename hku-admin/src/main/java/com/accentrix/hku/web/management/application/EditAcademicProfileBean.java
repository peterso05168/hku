...
* @date 创建时间：2018年5月30日 下午2:55:38 
*/
@ManagedBean
@ViewScoped
@Configurable(preConstruction = true)
public class EditAcademicProfileBean implements Serializable {

    private static final long serialVersionUID = 1L;
    private static final Logger LOG = LoggerFactory.getLogger(EditAcademicProfileBean.class);
    ...
    private List<RefCdVo> highestQualificationCds;
    ...
    public EditAcademicProfileBean() {
        init();
    }
    ...
    private void retrieveData(String applicationId) {
        highestQualificationCds = refCdService.findListByType(Constants.HIGHEST_QUALIFICATION);
            ...
            if (acadBgVo != null) {
                ...
                if (StringUtils.isNotBlank(acadBgVo.getHighestQualificationCd())) {
                    if (!Constants.HIGHEST_QUALIFICATION_CD.contains(acadBgVo.getHighestQualificationCd())) {
                        if (StringUtils.isNotBlank(applicationId)) {
                            List<ProgrammeChoiceVo> choiceList = programmeChoiceService
                                    .getChoiceByApplicationId(applicationId);
    ...
    public List<RefCdVo> getHighestQualificationCds() {
        return highestQualificationCds;
    }

    public void setHighestQualificationCds(List<RefCdVo> highestQualificationCds) {
        this.highestQualificationCds = highestQualificationCds;
    }
