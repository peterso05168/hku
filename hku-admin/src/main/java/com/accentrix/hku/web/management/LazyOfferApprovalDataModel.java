...
public class LazyOfferApprovalDataModel extends LazyDataModel<ProgrammeChoiceVo> {

    private static final Logger LOG = LoggerFactory.getLogger(LazyOfferApprovalDataModel.class);
    ...
    public LazyOfferApprovalDataModel(ProgrammeChoiceVo programmeChoiceVo) {
