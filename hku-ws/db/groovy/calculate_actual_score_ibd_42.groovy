...
CREATE PROCEDURE calculate_actual_score_IBD_42()
BEGIN
	...
	END IF;
		...
		BEGIN
			...
			AND calculate_type = 'Actual' AND out_of = '42';
			...
			INSERT INTO app_ibd_best_exam (app_ibd_best_exam_id,application_id,app_qualification_id,total_rslt,calculate_type,out_of) 
						VALUES (@ibd_best_exam_id,applicationid,qualification_id,total_rslt,'Actual','42');
...
hkuSql.execute('DROP PROCEDURE IF EXISTS calculate_actual_score_IBD_42')
hkuSql.execute(sql)