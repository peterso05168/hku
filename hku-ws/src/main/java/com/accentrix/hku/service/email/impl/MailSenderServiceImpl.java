package com.accentrix.hku.service.email.impl;
...
import com.accentrix.hku.vo.email.MailAuthenticator;
import com.accentrix.hku.vo.email.MailInfo;

/**
 * @author Jaye.Lin
 * @date 创建时间：2018年3月28日 上午10:12:06
 * @version 1.0
 */
...
public class MailSenderServiceImpl implements MailSenderService {
    ...
    public boolean sendTextMail(MailInfo mailInfo, int mailType) {
        try {
            mailInfo = mailInfo.getInstance(mailInfo);
            // 需要身份认证，创建一个密码验证器
