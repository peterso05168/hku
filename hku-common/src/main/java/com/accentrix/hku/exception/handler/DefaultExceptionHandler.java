/*
 * $Id: DefaultExceptionHandler.java 15851 2015-09-15 04:17:27Z jyang $
 * 
...
public class DefaultExceptionHandler implements ExceptionHandler {
    ...
    @Override
    public void handle(Throwable t, String[] updates, String message, String messageKeyPrefix) {
        LOG.info("handling Throwable: {}, update: {}", t.getMessage(), updates);
    ...
    protected void updateMessage(String[] updates) {
        for (String up : updates) {
            UIUtil.update(up, true);
        }
    }
